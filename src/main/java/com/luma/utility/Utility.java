...
//*************************** Action Methods ***************************************//
    ...
    public void mouseHoverForThreeElement(WebElement e ,WebElement e2, WebElement e3){
        Actions actions = new Actions(driver);
        actions.moveToElement(e).moveToElement(e2).moveToElement(e3).click().build().perform();
    }
...
//***************************** Is Display Methods **********************************************//
    ...
    /**
     This is method will use to text verify.
     */
    ...
    public void verifyText(By by,String expectedText,String Text){
        Assert.assertEquals(getTextFromElement(by),expectedText,Text);
    }
